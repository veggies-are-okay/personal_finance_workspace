...
| Path | Role |
|------|------|
| `app/main.py` | `create_app`, CORS, canonical exception handlers, routers (`GET /health`, `GET /api/v1/transactions`, `GET /api/v1/budget`, `GET /api/v1/debt`; more view/source/connections routes per the checklist). |
