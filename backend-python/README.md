...
| Path | Role |
|------|------|
| `app/main.py` | `create_app`, CORS, canonical exception handlers, routers (`GET /health`, the P4 view endpoints, and the P6.1 connections API — `POST /api/v1/connections/link-token`, `POST /api/v1/connections/exchange`, `GET /api/v1/connections`, `POST /api/v1/connections/webhook`; more source routes per the checklist). |
