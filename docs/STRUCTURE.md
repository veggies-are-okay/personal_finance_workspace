...
│   │                          #       RecurringChargeOut + Debt/DebtTranche/PayoffProjection/LoanOut) ·
│   │                          #       main.py (create_app, CORS, handlers, /health + tx + budget + debt)
...
│   │                          #     value-parity: transactions P4.1 + budget P4.2 + debt P4.5) · http.ts
