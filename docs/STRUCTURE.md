...
│   │                          #       main.py (create_app, CORS, handlers, /health + tx + budget + networth)
...
│   │                          #     networth.e2e-spec.ts (Supertest;
...
│   │                          #     value-parity: transactions P4.1 + budget P4.2 + networth P4.3) · http.ts
